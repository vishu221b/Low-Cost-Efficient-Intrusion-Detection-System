...
class MQTTManager:
    ...
    def __init__(self, serial=None, payload_callback=None, subscribe_base=False) -> None:
        self.serial=serial
        self.base_topic=None
        self.controller_topic=None
        self.payload_callback=payload_callback
        self.subscribe_base=subscribe_base
    ...
    def on_connect(self, client, userdata, flags, rc):
        ...
        if self.subscribe_base and self.base_topic:
            print(f"Established connection to MQTT, subscribing to {self.base_topic}!!")
